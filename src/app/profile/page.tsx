...
import { AppleIcon, Calendar1Icon, DumbbellIcon } from "lucide-react";
           ...
           {currentPlan && (
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold">PLAN: <span className="text-primary">{currentPlan.name}</span></h3>
              </div>
              ...
              <Tabs defaultValue="workout" className="w-full">
                <TabsList className="mb-6 w-full grid grid-cols-2 bg-cyber-terminal-bg border">
                  <TabsTrigger value="workout" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary">
                    <DumbbellIcon className="mr-2 size-4">Workout Plan</DumbbellIcon>
                  </TabsTrigger>

                  <TabsTrigger value="diet" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary">
                    <AppleIcon className="mr-2 h-4 w-4">Diet Plan</AppleIcon>
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="workout">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-4">
                      <Calendar1Icon className="h-4 w-4 text-primary" />
                          ...
                          <AccordionContent className="pb-4 px-4">
                            <div className="space-y-3 mt-2">
                              {exerciseDay.routines.map((routine, routineIndex) => (
                               <div className="border border-border rounded p-3 bg-background/50" key={routineIndex}>
